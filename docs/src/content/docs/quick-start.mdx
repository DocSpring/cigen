...
- [Cigen installed](/cigen/installation/) on your system
...
- Learn about [configuration options](/cigen/configuration/overview/)
- Explore [CircleCI-specific features](/cigen/providers/circleci/)
- Read about [advanced features](/cigen/advanced/multi-arch/) like OR dependencies
- Check out [real-world examples](/cigen/examples/)
