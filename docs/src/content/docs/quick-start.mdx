...
<Aside type="tip">
Notice how cigen automatically:
- Generated separate jobs for each architecture
- Set appropriate resource classes (`medium` vs `arm.medium`)
- Created proper dependency chains in the workflow
- Injected cache restore/save steps where needed
</Aside>
