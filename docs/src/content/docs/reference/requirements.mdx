...
<Aside type="note">
**Key Principle**: cigen is NOT a 1:1 port of existing CI systems. It represents a complete architectural redesign based on lessons learned from existing implementations.
</Aside>
