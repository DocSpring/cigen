...
<CardGrid>
  <Card title="CircleCI" icon="seti:config">
    Uses setup workflows with dynamic config to completely skip jobs before they
    start
  </Card>
...
<CardGrid>
  ...
  <Card title="Evolution" icon="forward">
    As platforms add features, cigen switches from workarounds to native
    implementations
  </Card>
</CardGrid>
...
<Aside type="tip">
  **The ultimate goal:** You describe WHAT you want your CI to do, and cigen
  figures out HOW to make it happen on any platform.
</Aside>
