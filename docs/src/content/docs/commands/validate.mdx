...
- [`generate`](/cigen/commands/generate/) - Generate configuration after validation
- See [configuration overview](/cigen/configuration/overview/) for config format details
