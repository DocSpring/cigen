...
#[test]
fn snapshot_circleci_rails_config() {
    let root = repo_root();
    let fixture = root.join("integration_tests/circleci_rails");
    // This fixture sets output_path to ./build
    let output_dir = fixture.join("build");
    ...
    assert_snapshot!("circleci_rails_config", normalized);
